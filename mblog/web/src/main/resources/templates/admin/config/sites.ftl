<form id="qForm" class="form-horizontal" method="post" action="update">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-8">
            ...
            <p class="help-block">示例: http://www.goodwillcis.com/</p>
        </div>
    </div>
    <div class="form-group">
	...
	<div class="form-group">
        ...
        <div class="col-lg-5">
            ...
            <p class="help-block">示例: Copyright © 2018 Goodwill All rights reserved</p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-5">
            ...
            <p class="help-block">示例: 京ICP备09033005</p>
        </div>
    </div>
    <div class="form-group">
